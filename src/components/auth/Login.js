...
function Login({ setlogin }) {
  return (
    <div className="z-50 bg-opacity-60 h-screen fixed bg-black top-0 left-0 w-full">
      <div className="  top-1/5 fixed left-1/4 min-h-[35rem] max-w-[1000px] flex m-auto  top-[5rem] shadow-lg">
        <div className="flex-[0.5] p-5 bg-[#6FBCF3] flex items-center justify-center flex-col text-white font-body">
          ...
          <button
            id="signUpBtn"
            className="p-[10px] bg-transparent border-2 border-solid border-black w-[150px] rounded-2xl mt-[10px]"
          >
            Sign Up
          </button>
        </div>
          ...
          <div className="flex flex-col h-[100%] p-[30px] justify-between">
            ...
            <form action="">
              ...
              <div className="max-w-[300px] m-auto">
                <button
                  id="submitBtn"
                  className="p-[10px] w-full mt-[30px] cursor-pointer border-none bg-[#F28C8C] text-white"
                >
                  Continue
                </button>
              </div>
