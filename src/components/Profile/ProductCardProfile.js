  ...
  return (
    <div className='bg-[#F5F5F5] rounded-md p-4 flex my-2'>
        <div className="imageContent flex-[0.2] p-1 bg-white">
            <img src={imageUrl} alt="Product Image" className='h-[250px] w-[250px] object-contain'/>
        </div>
        <div className="productDescription flex-[0.8] p-3">
            ...
            <p className='mb-2'>By Tejas Sonar</p>
            ...
            <div className="quantitySelection flex justify-start items-center">
                <label htmlFor="quantity" className='font-semibold mr-2'>Quantity:</label>
                <select name="quantity" id="quantity" value="1" className='p-1 w-12 border-black border-1'>
