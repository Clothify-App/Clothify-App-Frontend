        ...
        >
          <div className="option1 flex">
            <div className="option flex flex-col justify-center w-1/2 mr-5">
              ...
              <label
                htmlFor="title"
                className="text-[#00008B] after:content-['*'] font-bold"
              >
                Title
              </label>
              <input
          ...
          <div className="option1 flex">
            ...
            <div className="option flex flex-col justify-center w-1/2">
              ...
              <select
                ...
                value={forWhom}
                className="border-2 p-2 border-gray-400 rounded-md"
              >
          ...
          <div className="option flex flex-col justify-center">
            ...
            <label
              htmlFor=""
              className='py-1 after:content-["*"] text-[#00008B] font-bold'
            >
          ...
          <div className="option flex flex-col justify-center">
            ...
            <label
              ...
              className="text-[#00008B] after:content-['*'] font-bold"
            >
              Tag(any particular function wear)
            </label>
            <input
              required
              type="text"
          ...
          <div className="submitBtn flex justify-end mt-3 items-center">
            <button className="p-2 px-5 bg-black text-white font-semibold cursor-pointer hover:shadow-lg">
