...
const ProductCard = ({ title, price, rating, image, id, category }) => {
  return (
    ...
    >
      ...
      <span class="text-xs w-1/2 m-auto inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-gray-200 text-gray-700 rounded">
        {category}
      </span>
      ...
      <div className="border-pink-500 flex items-center justify-center border-2 p-2 cursor-pointer text-pink-500">
